        ...
        <div class="container-fluid">
            ...
            <form method="post" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-lg-6">
                        <input name="price" id="price" type="number" min="0" value="{{ old('price') }}" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-12 control-label" for="discount_percentage">Discount percentage<span class="required">*</span></label>
                    <div class="col-md-9 col-lg-6">
                        <input name="discount_percentage" id="discount_percentage" type="number" min="0" max="100" value="{{ old('discount_percentage', 0) }}" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-lg-6">
                        <input name="media_id" id="media_id" type="number" min="1" value="{{ old('media_id') }}" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-12 control-label" for="inventory_qty">Inventory quantity<span class="required">*</span></label>
                    <div class="col-md-9 col-lg-6">
                        <input name="inventory_qty" id="inventory_qty" type="number" min="0" value="{{ old('inventory_qty') }}" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-lg-6">
                        <input name="star" id="star" type="number" min="0" max="5" step="0.1" value="{{ old('star', 0) }}" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-lg-6">
                        <select name="status" id="status" class="form-control">
                            <option value="0" @selected(old('status') == 0)>@lang('translate.inactive')</option>
                            <option value="1" @selected(old('status', 1) == 1)>@lang('translate.active')</option>
                        </select>
                    </div>
                </div>
