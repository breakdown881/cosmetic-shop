    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="action-bar">
                <a href="{{ route('admin.product.create.child', ['id' => $product->id]) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button
                                                ...
                                                data-url="{{ route('admin.product.change_status', ['product' => $child->id]) }}">
                                        ...
                                        <td class="text-center row">
                                            <div class="col-md-4">
                                                <a href="{{ route('admin.product.edit.child', ['id' => $product->id, 'product' => $child->id]) }}"
                                            ...
                                            <div class="col-md-4">
                                                <form id="delete-form-{{ $child->id }}" class="hidden"
                                                    action="{{ route('admin.product.destroy', ['product' => $child->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
