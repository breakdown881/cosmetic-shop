    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                @if (!empty($isChild))
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.product.list', ['id' => $parent->id]) }}">
                            {{ $parent->name }}
                        </a>
                    </li>
                @endif
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-lg-6">
                        <select name="status" id="status" class="form-control">
                            <option value="0" {{$product->status ? '' : 'selected'}}>@lang('translate.inactive')</option>
                            <option value="1" {{$product->status ? 'selected' : ''}}>@lang('translate.active')</option>
                        </select>
                    </div>
                </div>
